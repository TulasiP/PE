   ...
   public void validateUid(Map<String, String> request)
   {
	   long uid=0;
		try
		{
			...
			try
			{
				uid=Long.parseLong(request.get("uid"));
			}
			catch(Exception e)
			{
	   ...
	   try
		{
			...
			try
			{
				age=Long.parseLong(request.get("age"));
			}
			catch(Exception e)
			{
   ...
   public void validateWeight(Map<String, String> request)
   {
	   ...
	   try
		{ 
		   ...
		   try
		   {
			   weight=Long.parseLong(request.get("weight"));
		   }
		   catch(Exception e)
		  {
   ...
   public void validateAadhaarno(Map<String, String> request)
   {
	   long aadhaarno=0;
		try
		{
			...
			try
			{
				aadhaarno=Long.parseLong(request.get("aadhaarno"));
			}
			catch(Exception e)
			{
   ...
   public void validateMobilenumber(Map<String, String> request)
   {
	   ...
	   long mobilenumber=0;
		try
		{
			...
			try
			{
				mobilenumber=Long.parseLong(request.get("mobilenumber"));
			}
			catch(Exception e)
			{
   ...
   public void validateStudytype(Map<String, String> request)
   {
	   String studytype;
		try
		{
			...
			try
			{
				studytype=request.get("studytype");
